(function () {
  ...
  const CHAPTERS = [
    ...
    "Photosynthesis in Higher Plants ☘️",
  ...
  window.SUBJECT_DATA = {
    title: "Botany by Vipin",
    subtitle: "Biology",
    updatedDate: null,
    columns: COLUMNS,
    rows: CHAPTERS.map((c, i) => blankRow("botany_row_" + i, c))
  };

  window.SUBJECT_META = { subjectKey: "biology", partKey: "botany" };
})();
