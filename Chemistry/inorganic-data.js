(function () {
  ...
  // No chapter list was supplied for Inorganic — standard chapters used as a
  // starting point. Edit/replace freely in Editor mode.
  const CHAPTERS = [
  ...
  window.SUBJECT_DATA = {
    ...
    updatedDate: null,
    columns: COLUMNS,
    rows: CHAPTERS.map((c, i) => blankRow("inorganic_row_" + i, c))
  };

  window.SUBJECT_META = { subjectKey: "chemistry", partKey: "inorganic" };
})();
