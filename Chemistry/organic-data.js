(function () {
  ...
  // No chapter list was supplied for Organic — standard chapters used as a
  ...
  window.SUBJECT_DATA = {
    ...
    updatedDate: null,
    columns: COLUMNS,
    rows: CHAPTERS.map((c, i) => blankRow("organic_row_" + i, c))
  };

  window.SUBJECT_META = { subjectKey: "chemistry", partKey: "organic" };
})();
